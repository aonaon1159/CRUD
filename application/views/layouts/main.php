...
<head>
    ...
    <title>CRUD จัดการข้อมูลรถ</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('resources/css/card.css');?>">
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="<?php echo base_url();?>" class="logo">
                    ...
                    <span class="logo-mini">ขายรถ</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">ขายรถ</span>
                </a>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo base_url('resources/img/car.png');?>" class="img-circle" alt="User Image">
                    </div>
                    <div class="pull-left info">
                        <p>การจัดการข้อมูลรถยนต์</p>
                        <a href="#"> </a>
                    </div>
                </div>
                ...
                <ul class="sidebar-menu"> 
                    <li>
                        <a href="<?php echo site_url('car_type/index'); ?>">
                            <i class="fa fa-truck"></i> <span>จัดการชนิดรถ</span>
                        </a> 
                    </li> 

                    <li>
                        <a href="<?php echo site_url('car_brand/index'); ?>">
                            <i class="fa fa-copyright"></i> <span>จัดการแบรนด์รถ</span>
                        </a> 
                    </li> 
                    ...
                    <li>
                        <a href="<?php echo site_url('car_version/index'); ?>">
                            <i class="fa fa-car"></i> <span>จัดการรุ่นรถ</span>
                        </a> 
                    </li> 
                    <li>
                        <a href="<?php echo site_url('car_detail/index'); ?>">
                            <i class="fa fa-info-circle"></i> <span>จัดการข้อมูลรถ</span>
                        </a> 
                    </li> 
                </ul>
