...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Car_brand  Listing</h3>
              <div class="box-tools">
                <a href="<?php echo site_url('car_brand/add'); ?>" class="btn btn-success btn-sm">Add</a> 
                </div>
   <?php echo $this->session->flashdata('alert_msg');?>
           ...
           {
           foreach($car_brand as $c){ ?>
                    <tr>
                    <td><?php echo $i++; ?></td>
                    <td><?php echo $c['brand_name']; ?></td>
                     <td><a href="<?php echo site_url('car_brand/edit/'.$c['brand_id']); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a> 
                         <a
                            onclick="return confirm('Are you sure You want to delete?')"
                             href="<?php echo site_url('car_brand/remove/'.$c['brand_id']); ?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span> Delete</a>
                     </td>
                    </tr>
                     <?php }
